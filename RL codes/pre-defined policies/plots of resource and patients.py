...
plt.grid(True)
plt.tight_layout()
pdf_path = os.path.join('/Users/bozhisun/Desktop/echo project', '5 1 0.75 resources.pdf')
...
plt.grid(True)
plt.tight_layout()
pdf_path = os.path.join('/Users/bozhisun/Desktop/echo project', '5 1 0.75 patients mean.pdf')
plt.savefig(pdf_path, format='pdf')
plt.close()
...
plt.grid(True)
plt.tight_layout()
pdf_path = os.path.join('/Users/bozhisun/Desktop/echo project', '5 1 0.75 patients sd.pdf')
plt.savefig(pdf_path, format='pdf')
plt.close()