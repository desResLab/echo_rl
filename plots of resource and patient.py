...
plt.grid(True)
plt.tight_layout()
pdf_path = os.path.join('/Users/bozhisun/Desktop/echo project', '5 100 100 resources.pdf')
...
plt.grid(True)
plt.tight_layout()
pdf_path = os.path.join('/Users/bozhisun/Desktop/echo project', '5 100 100 patients mean.pdf')
plt.savefig(pdf_path, format='pdf')
plt.close()
...
plt.grid(True)
plt.tight_layout()
pdf_path = os.path.join('/Users/bozhisun/Desktop/echo project', '5 100 100 patients sd.pdf')
plt.savefig(pdf_path, format='pdf')
plt.close()