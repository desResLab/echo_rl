...
class Echo:
    ...
    def reset(self):
        ...
        state = [self._ontime_waiting_fetal_patients(), self._late_waiting_fetal_patients(), self._early_waiting_fetal_patients(),
                 self._ontime_waiting_nonfetal_patients(), self._late_waiting_nonfetal_patients(), self._early_waiting_nonfetal_patients(),
                 self._available_fetal_sonograpphers(), self._available_nonfetal_sonograpphers(), self._available_fetal_rooms(),
                 self._available_nonfetal_rooms(), self._onbreak_fetal_sonograpphers(), self._onbreak_nonfetal_sonograpphers(),
                 self.env.now]
        return state
